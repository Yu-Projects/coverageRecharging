...
function [v_AdjNew, distances] = makingSTWType1(maxDistance, x, y, numPoints, numLevels, v_Cluster, v_ClusterLevel)

[sNew, tNew, weights, v_AdjNew, distances] =  makingSTWv_Adj(maxDistance, x, y, numPoints, numLevels, v_Cluster);
